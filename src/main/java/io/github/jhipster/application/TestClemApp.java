...
public class TestClemApp {

    private static final Logger log = LoggerFactory.getLogger(TestClemApp.class);

    private final Environment env;

    public TestClemApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes testClem.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TestClemApp.class);
